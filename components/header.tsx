...
export function Header() {
  ...
  const earlyAccessMenuAria = t('trustora.early_access.header.mobile_menu_aria', {defaultValue: 'Meniul principal pe mobil'});
  const earlyAccessMenuTitle = t('trustora.early_access.header.mobile_menu_title', {defaultValue: 'Meniu înscriere early access'});
  const earlyAccessMenuLabel = t('trustora.early_access.header.mobile_menu_label', {defaultValue: 'Meniu'});
  const earlyAccessMenuDescription = t(
    'trustora.early_access.header.mobile_menu_description',
    {defaultValue: 'Alege tipul de cont pentru înscriere în early access.'},
  );
  const earlyAccessMenuSrDescription = t(
    'trustora.early_access.header.mobile_menu_sr_description',
    {defaultValue: 'Alege tipul de cont pentru înscriere în early access și accesează detaliile de contact Trustora.'},
  );
  const earlyAccessContactLabel = t('trustora.early_access.header.contact_label', {defaultValue: 'Date de contact'});
  const earlyAccessContactTag = t('trustora.early_access.header.contact_tag', {defaultValue: 'Trustora'});
  const earlyAccessBannerText = t(
    'common.banner.early_access_enabled',
    {defaultValue: 'Early access funnel is enabled.'},
  );
  const basicAuthBannerText = t(
    'common.banner.basic_auth_enabled',
    {defaultValue: 'Basic authentication is enabled.'},
  );
