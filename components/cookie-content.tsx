            ...
            <div className="overflow-x-auto">
              <table className="w-full border-separate border-spacing-0 text-left text-sm">
                ...
                <tbody className="text-slate-600 dark:text-slate-300">
                  <tr>
                    <td className="border-b border-slate-200/60 py-2 pr-4 dark:border-slate-700">authjs.session-token / __Secure-authjs.session-token</td>
                    ...
                    <td className="border-b border-slate-200/60 py-2 pr-4 dark:border-slate-700">
                      Gestionează sesiunea securizată NextAuth JWT și vă menține autentificat în aplicație.
                    </td>
                    <td className="border-b border-slate-200/60 py-2 dark:border-slate-700">Sesiune</td>
                  </tr>
                  <tr>
                    <td className="border-b border-slate-200/60 py-2 pr-4 dark:border-slate-700">trustora-remember / trustora-browser-session</td>
                    <td className="border-b border-slate-200/60 py-2 pr-4 dark:border-slate-700">Trustora</td>
                    <td className="border-b border-slate-200/60 py-2 pr-4 dark:border-slate-700">
                      Memorează preferința de autentificare: 30 de zile sau doar până la închiderea browserului.
                    </td>
                    <td className="border-b border-slate-200/60 py-2 dark:border-slate-700">30 zile / sesiune</td>
                  </tr>
                  <tr>
              ...
              <table className="w-full border-separate border-spacing-0 text-left text-sm">
                ...
                <tbody className="text-slate-600 dark:text-slate-300">
                  <tr>
                    ...
                    <td className="border-b border-slate-200/60 py-2 pr-4 dark:border-slate-700">Trustora</td>
                    <td className="border-b border-slate-200/60 py-2 pr-4 dark:border-slate-700">
                      Manages the secure NextAuth JWT session and keeps you signed in to the app.
                    </td>
                  ...
                  <tr>
                    ...
                    <td className="border-b border-slate-200/60 py-2 pr-4 dark:border-slate-700">Trustora</td>
                    <td className="border-b border-slate-200/60 py-2 pr-4 dark:border-slate-700">
                      Stores whether your sign-in should persist for 30 days or end when the browser closes.
                    </td>
                    <td className="border-b border-slate-200/60 py-2 dark:border-slate-700">30 days / session</td>
                  </tr>
                  <tr>
                    <td className="border-b border-slate-200/60 py-2 pr-4 dark:border-slate-700">__stripe_mid</td>
