export function TrustoraPillarsSection() {
    return (
            ...
            <div className="max-w-7xl mx-auto">
                <div className="grid md:grid-cols-4 gap-8">
                    <div className="space-y-4">
                        ...
                        <h3 className="text-sm font-bold uppercase tracking-widest text-[#0B1C2D] dark:text-[#E6EDF3]">Verified People</h3>
                    ...
                    <div className="space-y-4">
                        ...
                        <h3 className="text-sm font-bold uppercase tracking-widest text-[#0B1C2D] dark:text-[#E6EDF3]">Protected Money</h3>
                        <p className="text-sm text-slate-500 leading-relaxed dark:text-[#A3ADC2]">
                    ...
                    <div className="space-y-4">
                        ...
                        <h3 className="text-sm font-bold uppercase tracking-widest text-[#0B1C2D] dark:text-[#E6EDF3]">Enforced Delivery</h3>
                        <p className="text-sm text-slate-500 leading-relaxed dark:text-[#A3ADC2]">
                    ...
                    <div className="space-y-4">
                        ...
                        <h3 className="text-sm font-bold uppercase tracking-widest text-[#0B1C2D] dark:text-[#E6EDF3]">Legal-grade contracts</h3>
                        <p className="text-sm text-slate-500 leading-relaxed dark:text-[#A3ADC2]">
