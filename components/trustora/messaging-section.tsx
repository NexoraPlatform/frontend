...
export async function TrustoraMessagingSection({ locale }: { locale: Locale }) {
    const [
        ...
        t(locale, "homepage.trustora.messaging.clients_badge"),
        t(locale, "homepage.trustora.messaging.clients_title"),
        t(locale, "homepage.trustora.messaging.clients_body"),
        t(locale, "homepage.trustora.messaging.clients_benefit_one"),
        t(locale, "homepage.trustora.messaging.clients_benefit_two"),
        t(locale, "homepage.trustora.messaging.clients_link"),
        t(locale, "homepage.trustora.messaging.pros_badge"),
        t(locale, "homepage.trustora.messaging.pros_title"),
        t(locale, "homepage.trustora.messaging.pros_body"),
        t(locale, "homepage.trustora.messaging.pros_benefit_one"),
        t(locale, "homepage.trustora.messaging.pros_benefit_two"),
        t(locale, "homepage.trustora.messaging.pros_link"),
    ]);
