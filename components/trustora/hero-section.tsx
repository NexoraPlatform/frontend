...
import { TrustFlowNetwork } from "@/components/trustora/trust-flow-network";
...
export async function TrustoraHeroSection({ locale }: { locale: Locale }) {
    ...
    return (
        <section className="relative overflow-hidden bg-[#0B1C2D] pt-40 pb-20 px-6 min-h-[720px]">
            <div className="absolute inset-0">
                <div className="absolute inset-0 hidden md:block pointer-events-none">
                    <TrustFlowNetwork />
                </div>
                <div className="absolute inset-0 md:hidden bg-[radial-gradient(circle_at_top,#123053_0%,#0B1C2D_45%,#08111D_100%)]" />
                <div className="absolute inset-0 bg-gradient-to-b from-[#0B1C2D]/10 via-[#0B1C2D]/55 to-[#0B1C2D]/95" />
            </div>
            ...
            <div className="relative z-10 max-w-7xl mx-auto grid lg:grid-cols-2 gap-12 items-center">
                <div>
                    ...
                    <div className="flex flex-col sm:flex-row gap-4">
                        <button className="px-8 py-4 btn-primary text-white font-semibold rounded-xl text-lg shadow-lg shadow-emerald-500/30">
                            {primaryCta}
                        </button>
                    ...
                    <div className="mt-10 flex items-center gap-4 text-sm text-slate-200/70">
                        <div className="flex -space-x-2">
                            <div className="w-8 h-8 rounded-full border-2 border-white/30 bg-white/20" />
                            <div className="w-8 h-8 rounded-full border-2 border-white/30 bg-white/30" />
                            <div className="w-8 h-8 rounded-full border-2 border-white/30 bg-white/40" />
                        </div>
                ...
                <div className="relative">
                    <div className="rounded-2xl p-6 relative z-10 bg-[#0E2238]/80 border border-white/10 backdrop-blur">
                        ...
                        <div className="space-y-4">
                            <div className="p-4 rounded-xl bg-[#0B1C2D]/70 border border-white/10">
                                <div className="flex justify-between items-center mb-2">
                                    <span className="text-sm font-semibold text-white">{contractName}</span>
                                    <span className="mono text-sm font-bold text-white">{contractValue}</span>
                                </div>
                            ...
                            <div className="flex gap-3">
                                <div className="flex-1 p-3 rounded-xl border border-dashed border-white/20 flex flex-col items-center justify-center text-slate-300 italic text-xs">
                    ...
                    <div className="absolute -top-16 -right-16 w-48 h-48 bg-emerald-500/10 rounded-full blur-3xl opacity-60 -z-0" />
                    <div className="absolute -bottom-16 -left-16 w-48 h-48 bg-blue-500/10 rounded-full blur-3xl opacity-60 -z-0" />
                </div>
            </div>
        </section>
    );
