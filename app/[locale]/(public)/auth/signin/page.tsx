        ...
        <div className="mx-auto flex max-w-7xl items-center">
          <div className="grid w-full grid-cols-1 gap-12 lg:grid-cols-2 lg:items-center">
            ...
            <div className="flex justify-center lg:justify-end">
              <div className="glass-effect relative w-full max-w-md overflow-hidden rounded-[2rem] border border-slate-200/80 bg-white/90 p-8 shadow-[0_30px_80px_-40px_rgba(15,23,42,0.24)] dark:border-white/10 dark:bg-background/70 dark:shadow-[0_30px_80px_-40px_rgba(0,0,0,0.65)] sm:p-10">
                ...
                <div className="relative z-10 space-y-8">
                  ...
                  <form onSubmit={handleSubmit} className="space-y-5">
                    <div className="space-y-2">
                      ...
                      <div className="relative">
                        ...
                        <Input
                          ...
                          className={cn(signinFieldClassName, "pl-11")}
                          required
                        />
                      </div>
                    </div>
                    ...
                    <div className="space-y-2">
                      ...
                      <div className="relative">
                        ...
                        <Input
                          ...
                          className={cn(signinFieldClassName, "pl-11 pr-11")}
                          required
                        />
                        <Button
                          type="button"
                    ...
                    <div className={cn(signinSurfaceClassName, "flex items-start justify-between gap-4 px-4 py-3 dark:bg-[#08111B]/80")}>
                      <div className="space-y-1">
                        <Label
                          htmlFor="remember-me"
