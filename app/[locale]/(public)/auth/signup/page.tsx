        ...
        <div className="mx-auto max-w-7xl">
          <div className="grid grid-cols-1 gap-12 lg:grid-cols-[0.9fr_1.1fr] lg:items-start">
            ...
            <div className="flex justify-center lg:justify-end">
              <div className="glass-effect relative w-full max-w-2xl overflow-hidden rounded-[2rem] border border-slate-200/80 bg-white/90 p-8 shadow-[0_30px_80px_-40px_rgba(15,23,42,0.24)] dark:border-white/10 dark:bg-background/70 dark:shadow-[0_30px_80px_-40px_rgba(0,0,0,0.65)] sm:p-10">
                ...
                <div className="relative z-10 space-y-8">
                  ...
                  <form onSubmit={handleSubmit} className="space-y-5">
                      ...
                      <div className="space-y-2">
                        ...
                        <div className="relative">
                          ...
                          <Input
                            ...
                            className={cn(signupFieldClassName, "pl-11")}
                            required
                          />
                        </div>
                      </div>
                    ...
                    <Form {...billingForm}>
                      <BillingDetailsForm
                        useLocationApi
                        fieldClassName={signupFieldClassName}
                        className={cn(signupSurfaceClassName, "p-4")}
                      />
                    </Form>
                      ...
                      <div className="space-y-2">
                        ...
                        <div className="relative">
                          ...
                          <Input
                            ...
                            className={cn(signupFieldClassName, "pl-11 pr-11")}
                            required
                            minLength={8}
                          />
                          <Button
                    ...
                    <div className={cn(signupSurfaceClassName, "p-4")}>
                      <div className="max-h-64 overflow-y-auto pr-2">
                        <TermsContent className="text-xs" headingClassName="text-base" />
                      </div>
                    </div>

                    <div className={cn(signupSurfaceClassName, "flex items-center gap-3 p-4")}>
                      <Checkbox
                        id="terms"
