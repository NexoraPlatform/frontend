...
export async function generateMetadata({ params }: PageProps): Promise<Metadata> {
  ...
  return generateSEO({
    title: isEnglish ? 'Context-aware AI search' : 'Cautare AI in functie de context',
    description: isEnglish
      ? 'Search services, projects, and providers in the correct AI namespace.'
      : 'Cauta servicii, proiecte si prestatori in namespace-ul AI potrivit.',
    locale,
    url: '/search/ai',
    robots: {
      index: false,
