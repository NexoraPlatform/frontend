...
export async function generateMetadata({ params }: ProjectsPageProps): Promise<Metadata> {
  ...
  return generateSEO({
    title: isEnglish ? 'Projects' : 'Proiecte',
    description: isEnglish
      ? 'Find projects that match your expertise and bid in a safe, verified ecosystem.'
      : 'Gaseste proiecte potrivite expertizei tale si aplica intr-un ecosistem sigur si verificat.',
    locale,
    url: '/projects',
  });
}
