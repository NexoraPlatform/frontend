              ...
              <div className="max-w-4xl mx-auto">
                ...
                <div className="flex flex-col sm:flex-row gap-8 justify-center">
                  ...
                  <Button
                      size="lg"
                      variant="outline"
                      className="px-16 py-8 text-2xl font-bold border-3 border-white text-white hover:bg-white/10 rounded-2xl shadow-lg transform hover:scale-105 transition-all duration-200"
