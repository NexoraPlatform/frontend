...
interface NewProviderServicePageProps {
  searchParams: {
    serviceId?: string;
  };
}

export default function NewProviderServicePage({ searchParams }: NewProviderServicePageProps) {
  ...
  useEffect(() => {
    ...
    if (searchParams.serviceId) {
      loadService(searchParams.serviceId);
    }
  }, [user, loading, router, searchParams.serviceId]);
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      await apiClient.addServiceProvider(searchParams.serviceId, providerData);
        ...
        <div className="flex items-center space-x-4 mb-8">
          ...
          <div>
            ...
            <p className="text-muted-foreground">
              Setează-ți tarifele și condițiile pentru acest serviciu
            </p>
          </div>
        </div>
        ...
        <form onSubmit={handleSubmit} className="max-w-4xl space-y-8">
          ...
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Alege tipul de tarif și setează prețurile tale
              </CardDescription>
            </CardHeader>
              ...
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="text-sm text-muted-foreground">
                    Permite clienților să negocieze prețul
                  </p>
                </div>
                <Switch
